...
for file in all_ref_files:
    ...
    dimensions_names = [
        "pos leg_left_ankle_roll_joint",
        "pos leg_left_ankle_pitch_joint",
        "pos leg_left_knee_pitch_joint",
        "pos leg_left_hip_pitch_joint",
        "pos leg_left_hip_yaw_joint",
        "pos leg_left_hip_roll_joint",
        "pos leg_right_ankle_roll_joint",
        "pos leg_right_ankle_pitch_joint",
        "pos leg_right_knee_pitch_joint",
        "pos leg_right_hip_pitch_joint",
        "pos leg_right_hip_yaw_joint",
        "pos leg_right_hip_roll_joint",
        "pos left_wrist_attachment_joint",
        "pos left_fore_arm_joint",
        "pos left_upper_arm_joint",
        "pos left_shoulder_joint",
        "pos right_wrist_attachment_joint",
        "pos right_fore_arm_joint",
        "pos right_upper_arm_joint",
        "pos right_shoulder_joint",
        "vel leg_left_ankle_roll_joint",
        "vel leg_left_ankle_pitch_joint",
        "vel leg_left_knee_pitch_joint",
        "vel leg_left_hip_pitch_joint",
        "vel leg_left_hip_yaw_joint",
        "vel leg_left_hip_roll_joint",
        "vel leg_right_ankle_roll_joint",
        "vel leg_right_ankle_pitch_joint",
        "vel leg_right_knee_pitch_joint",
        "vel leg_right_hip_pitch_joint",
        "vel leg_right_hip_yaw_joint",
        "vel leg_right_hip_roll_joint",
        "vel left_wrist_attachment_joint",
        "vel left_fore_arm_joint",
        "vel left_upper_arm_joint",
        "vel left_shoulder_joint",
        "vel right_wrist_attachment_joint",
        "vel right_fore_arm_joint",
        "vel right_upper_arm_joint",
        "vel right_shoulder_joint",
        "foot_contacts left",
        "foot_contacts right",
        "base_linear_vel x",
        "base_linear_vel y",
    ...
    plt.tight_layout()
    plt.savefig(f"recordings/plots/poly_fit_{tmp[0]}.png") # ASMR
    # plt.show()
